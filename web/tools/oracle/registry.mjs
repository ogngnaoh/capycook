...
export const REGISTRY = [
  ...
  A('BC-G-8', 'hit areas ≥24×24 on core + recovery surfaces', ['g/desktop-modes', 'g/narrow-390', 'g/reduced-motion'], { exempt: 'no-generation' }),
  A('BC-G-9', 'focus visible at every Tab stop, both themes', ['g/desktop-modes', 'g/reduced-motion'], { exempt: 'no-generation' }),
  A('BC-G-10', 'text contrast meets AA numerically, both themes', ['g/desktop-modes'], { failsToday: true, exempt: 'no-generation' }),
  A('BC-G-11', 'focus indicator ≥3:1 against adjacent background', ['g/desktop-modes', 'g/reduced-motion'], { exempt: 'no-generation' }),
