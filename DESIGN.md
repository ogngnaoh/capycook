...
> **Amended 2026-07-06:** sequencing below is superseded by the end-to-end build spec (`docs/superpowers/specs/2026-07-06-end-to-end-build-design.md`); the exit criteria stand and are re-homed by that spec §2/§3. The v2 "live demo" deliverable is re-scoped to a fork-friendly repo + demo GIFs/runbook (spec §1.5).
