...
| S7 | Media wave: 4 new GIFs, eval terminal capture, hero banner, social preview, SVG exports, portfolio MP4s | next | `docs/superpowers/plans/2026-07-10-milestone-02-s6-s8.md` |
