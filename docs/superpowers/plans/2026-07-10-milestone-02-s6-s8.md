...
> **S8 SUPERSEDED — 2026-07-14:** S6 and S7 below are a historical completed
> record. **Every remaining S8 instruction in this document is superseded by
> [`2026-07-14-milestone-02-s8-showcase-release.md`](2026-07-14-milestone-02-s8-showcase-release.md)
> and MUST NOT be executed.** Milestone 02 and S8 are shipped locally; the linked
> plan is now the historical release record and preserves the separate Task 7
> review, private-push, and public-visibility gates.
