...
02a. frontend-ia-redesign → docs/02a-frontend-redesign/ — shipped (2026-07-08: direction-A IA implemented + merged to master; 10-task plan, per-task + whole-branch review, evidence in the milestone folder)
