...
01. end-to-end-build → docs/01-end-to-end/   — shipped (2026-07-07: six phases, Gates A–D cleared, merged e2e → master at phase-6-handback; spec: docs/superpowers/specs/2026-07-06-end-to-end-build-design.md)
02. measure-run      → docs/02-measure-run/  — open, human-led (T1 instrument freeze, operator sessions, labeling campaign + second labeler, κ, results table)
02a. frontend-ia-redesign → docs/02a-frontend-redesign/ ← active (Claude-led, parallel to 02: implement the Claude Design direction-A IA in web/; backend/API frozen)
