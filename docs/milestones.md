...
02. measure-run      → docs/02-measure-run/  ← active (reframed 2026-07-08: solo tiered eval — deterministic verifier + blinded author R1 + LLM judge R2 — plus repo-showcase kit; spec: docs/superpowers/specs/2026-07-08-milestone-02-reframe-and-showcase-design.md; S8 publish + H2 sessions paused behind 02b since 2026-07-11)
...
02b. behavior-contract → docs/02b-behavior-contract/ ← active (inserted 2026-07-11 before S8 publish, 02a pattern: ratified UX behavior contract + hybrid headless oracle + autonomous fix→judge loop, motivated by the first live-latency operator session; spec: docs/superpowers/specs/2026-07-11-behavior-contract-oracle-loop-design.md)
