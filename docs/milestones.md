...
02. measure-run      → docs/02-measure-run/  ← active (reframed 2026-07-08: solo tiered eval — deterministic verifier + blinded author R1 + LLM judge R2 — plus repo-showcase kit; historical design spec: docs/superpowers/specs/2026-07-08-milestone-02-reframe-and-showcase-design.md; H2 is final at N=2 decisions across one session with USER-approved no-more-session decision; **S8/Gate A is active** for the reviewer-ready GitHub release and packaged current media)
