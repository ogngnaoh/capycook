...
| Model | **DeepSeek-V4-Pro**, OpenAI-compatible API | MIT-licensed, open weights, 1M context, ≈$1.74/M in ($0.0145/M cache-hit) / $3.48/M out, 5M free tokens; fits the "open, self-hostable in principle" thesis (§7 licensing) | 1.6T params ⇒ self-hosting needs 2–4×H100; **demo runs the hosted API**, stated plainly (§7) |
